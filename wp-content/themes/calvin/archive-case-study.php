                ...
                <div class="col-md-6 ">
                    <div class="">
                        ...
                        <div class="content contentheight">    
                            ...
                            <div class="title"> <a class="white" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></div>
            ...
            <div class="row">
              ...
              ?>  
                ...
                <div class="col-6 col-md-4 col-lg-3 ">
                  <?php 
                  if($link) :?>
                    <a href="<?php echo $link_url; ?>" target="<?php echo $link_target ?>"><img src="<?php the_sub_field('logo', 'options'); ?>"  alt=""></a> 
                  <?php 
                  else:?>
                    <div><img src="<?php the_sub_field('logo', 'options'); ?>"  alt=""></div> 
                  <?php endif;?>
               </div>
