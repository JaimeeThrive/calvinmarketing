            ...
            <div class="quadrooverlay">
                <div class="all-wrap">
                    ...
                    <div class=" readmorediv ">
                        <a href="<?php the_field('link'); ?>" class="readmore-wrap"><span><img
        ...
        <div class="">
            ...
            <div class="quadrooverlay">
                <div class="all-wrap">
                    ...
                    <div class=" readmorediv ">
                        <a href="<?php the_field('link1'); ?>" class="readmore-wrap"><span><img
                                    src="<?php the_field('read_more_icon', 'options'); ?>" alt=""></span> <span>Read
                                More</span> <span>Read more</span></a>
        ...
        <div class="">
            ...
            <div class="quadrooverlay">
                <div class="all-wrap">
                    ...
                    <div class=" readmorediv ">
                        <a href="<?php the_field('link2'); ?>" class="readmore-wrap"><span><img
                                    src="<?php the_field('read_more_icon', 'options'); ?>" alt=""></span> <span>Read
                                More</span> <span>Read more</span></a>
        ...
        <div class="">
            ...
            <div class="quadrooverlay">
                <div class="all-wrap">
                    ...
                    <div class=" readmorediv ">
                        <a href="<?php the_field('link3'); ?>" class="readmore-wrap"><span><img
                                    src="<?php the_field('read_more_icon', 'options'); ?>" alt=""></span> <span>Read
                                More</span> <span>Read more</span></a>
        ...
        setup_postdata($post); ?>
                ...
                <li class="swiper-slide ">
                    <div class="main-wrap">
                        ...
                        <picture>
                            <source srcset="<?php echo $img; ?>" media="(min-width: 768px)" />
...
<div class="clients">
    ...
    <div class="container ">
        ...
        ?>
            ...
            if($link) :?>
                    <a href="<?php echo $link_url; ?>" target="<?php echo $link_target ?>"><img
                            src="<?php the_sub_field('logo'); ?>" alt=""></a>
                    <?php 
            else:?>
                    <div style="display:flex;flex-direction:column;justify-content:center;"><img
                            ...
                            src="<?php the_sub_field('logo'); ?>" alt=""></div>
                    <?php endif;?>
                </div>
        ...
        <a href="<?php the_field('see_more'); ?>" class="readmore-wrap home_see_more"><span><img
